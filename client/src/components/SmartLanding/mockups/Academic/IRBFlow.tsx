...
/**
 * Academic IRB Approval Flow mockup. 4-step pipeline with active
 * highlight on "Data governance" — same shape as the Healthcare DSAR
 * stepper but with academic-specific copy.
 */
import { FileText, Scale, Database, CheckCircle2 } from "lucide-react";
...
const STEPS: readonly Step[] = [
  { key: "smartLanding.mockups.academic.irb_step_submit",   Icon: FileText,     pct: 100 },
  { key: "smartLanding.mockups.academic.irb_step_ethics",   Icon: Scale,        pct: 100 },
  { key: "smartLanding.mockups.academic.irb_step_data",     Icon: Database,     pct: 60  },
  { key: "smartLanding.mockups.academic.irb_step_decision", Icon: CheckCircle2, pct: 0   },
] as const;

export function IRBFlow() {
      ...
      <div dir={isAr ? "rtl" : "ltr"}>
        <div className="mb-3">
          <h4 className="text-base font-semibold text-[var(--text-primary)]">
            {t("smartLanding.mockups.academic.irb_title")}
          </h4>
          <p className="text-xs text-[var(--text-muted)]" dir="ltr">
            {t("smartLanding.mockups.academic.irb_subtitle")}
          </p>
        </div>
        ...
        <div className="rounded-md p-3 bg-[var(--bg-surface-2)] border border-[var(--border-color)] mb-3 space-y-1">
          <div className="text-[11px] text-[var(--text-secondary)] font-mono" dir="ltr">
            {t("smartLanding.mockups.academic.irb_meta_project")}
          </div>
          <div className="text-[11px] text-[var(--text-secondary)]">
            {t("smartLanding.mockups.academic.irb_meta_pi")}
          </div>
        </div>
